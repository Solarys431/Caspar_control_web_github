    ...
    socket.on('media:list', async (type, callback) => {
        ...
        try {
            ...
            callback({
                ...
                baseUrls: {
                    assets: assetsConfig?.httpBaseUrl || 'http://localhost:5000/assets',
                    caspar: 'caspar://server' // URL simbolico per media CasparCG
                },
                endpoints: {
                    templates: `${assetsConfig?.httpBaseUrl || 'http://localhost:5000/assets'}/templates/`,
                    images: `${assetsConfig?.httpBaseUrl || 'http://localhost:5000/assets'}/images/`,
                    video: `${assetsConfig?.httpBaseUrl || 'http://localhost:5000/assets'}/video/`,
                    audio: `${assetsConfig?.httpBaseUrl || 'http://localhost:5000/assets'}/audio/`,
                    graphics: `${assetsConfig?.httpBaseUrl || 'http://localhost:5000/assets'}/graphics/`,
                    logos: `${assetsConfig?.httpBaseUrl || 'http://localhost:5000/assets'}/logos/`
                },
